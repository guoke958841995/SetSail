...
public class AddressChouseDialog extends Dialog {

    public AddressChouseDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    public static class Params {
        private final List<BottomMenu> menuList = new ArrayList<BottomMenu>();
    ...
    public static class Builder {
        ...
        public AddressChouseDialog create() {
            final AddressChouseDialog dialog = new AddressChouseDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            View view = LayoutInflater.from(p.context).inflate(R.layout.dialog_addresschouse, null);

            TextView btnCancel = (TextView) view.findViewById(R.id.btn_add);
