...
public class StretchUtil{
    ...
    public StretchUtil(TextView textView, int lines, ImageView arrowImage,TextView tv,View moreCommentLL, int arrowUpId, int arrowDownId){
        this.textView = textView;
        this.lines = lines;
        this.arrowImage = arrowImage;
        this.tv = tv;
        this.moreCommentLL = moreCommentLL;
     ...
     */
    public static StretchUtil getInstance(TextView textView , int lines ,ImageView arrowImage ,TextView tv,View moreCommentLL, int arrowUpId ,int arrowDownId){
        return new StretchUtil(textView ,lines ,arrowImage ,tv,moreCommentLL,arrowUpId , arrowDownId);
    }
    ...
    public void setStretch(int status){
        if(status == -1){
            ...
            moreCommentLL.setVisibility(View.VISIBLE);
