...
public class BottomMenuDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public BottomMenuDialog create(boolean flage, Bitmap bm) {
            ...
            if (flage){
                view.findViewById(R.id.dialog_botton_menu_linearlayout).setVisibility(View.VISIBLE);
                ImageView IV = (ImageView) view.findViewById(R.id.dialog_botton_menu_image);
                IV.setImageBitmap(bm);
            }else{
                view.findViewById(R.id.dialog_botton_menu_linearlayout).setVisibility(View.GONE);
            }
