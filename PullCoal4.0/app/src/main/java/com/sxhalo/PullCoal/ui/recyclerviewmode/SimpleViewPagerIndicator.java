...
public class SimpleViewPagerIndicator extends LinearLayout {
    ...
    private static final int COLOR_INDICATOR_COLOR = R.color.app_title_text_color;
    ...
    public SimpleViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint.setColor(getResources().getColor(mIndicatorColor));
    ...
    private void generateTitleView() {
        ...
        for (int i = 0; i < count; i++) {
            final TextView radioButton= new TextView(getContext());
            LayoutParams lp = new LayoutParams(0,
                    LayoutParams.MATCH_PARENT);
            lp.weight = 1;
            radioButton.setGravity(Gravity.CENTER);
            radioButton.setTextColor(getResources().getColor(R.drawable.main_tab_item_text_color));
