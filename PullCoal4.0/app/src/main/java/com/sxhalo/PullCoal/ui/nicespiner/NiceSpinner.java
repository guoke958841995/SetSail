package com.sxhalo.PullCoal.ui.nicespiner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.dip5);
        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(R.dimen.dip12), defaultPadding, defaultPadding,
            defaultPadding);
        setClickable(true);

        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.nice_spiner_background_selector);
...
//        }
        ...
        if (!isArrowHide) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.nice_spiner_arrow);
