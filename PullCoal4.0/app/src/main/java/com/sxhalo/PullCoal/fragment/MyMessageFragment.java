...
public class MyMessageFragment extends Fragment  implements BaseAdapterUtils.BaseAdapterBack<UserGuestbook> {
    ...
    private void getData() {
        try {
            ...
            new DataUtils(myActivity, params).getMyGuestbookList(new DataUtils.DataBack<List<UserGuestbook>>() {
                @Override
