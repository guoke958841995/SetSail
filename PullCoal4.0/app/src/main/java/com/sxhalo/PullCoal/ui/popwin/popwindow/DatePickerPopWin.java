package com.sxhalo.PullCoal.ui.popwin.popwindow;
...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initView() {
        ...
        cancelBtn = (Button) contentView.findViewById(R.id.btn_add);
...
//        setAnimationStyle(R.style.FadeInPopWin);
    ...
    public void showPopupWindow(Activity activity,View location) {
        if (null != activity){
            if (Build.VERSION.SDK_INT < 24) {
                ...
                if (!this.isShowing()) {
                    ...
                    this.showAtLocation((activity).getWindow().getDecorView(), Gravity.NO_GRAVITY, 0, location.getHeight()+a[1]);
                    this.update();
                } else {
                    this.dismiss();
                }
