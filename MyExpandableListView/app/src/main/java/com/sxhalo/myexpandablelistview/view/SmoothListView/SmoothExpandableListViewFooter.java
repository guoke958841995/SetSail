...
public class SmoothExpandableListViewFooter extends LinearLayout {
    ...
    public SmoothExpandableListViewFooter(Context context) {
        super(context);
        initView(context);
    }

    public SmoothExpandableListViewFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
