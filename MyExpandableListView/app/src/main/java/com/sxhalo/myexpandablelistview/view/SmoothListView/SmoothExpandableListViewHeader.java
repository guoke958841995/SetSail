...
public class SmoothExpandableListViewHeader  extends LinearLayout {
    ...
    public SmoothExpandableListViewHeader(Context context) {
        super(context);
        initView(context);
    }

    public SmoothExpandableListViewHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
